...
- Name: auth.spec.ts >> User authentication >> user can login with valid admin credentials
- Location: tests\auth.spec.ts:112:3
...
Locator: getByText('admin@nc-mulia.com')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('admin@nc-mulia.com')
